...
const BestWorkers = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto p-4">
      <h2 className="text-3xl font-bold mb-6 text-center">Top Performing Workers</h2>
      <p className="text-accent text-center">Meet our workers who have earned the most through completing tasks</p>
      <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-6 gap-4">
        {workers.map((worker) => (
          <div
            key={worker._id}
            className="flex flex-col items-center p-4 border rounded shadow hover:shadow-lg transition"
          >
            <img
              src={worker.photo}
              alt={worker.name}
