  ...
  const slides = [
    {
      ...
      lottiePath: "/Finance.json", // Ensure these paths are correct in your public folder
      buttonText: "Start Earning Now",
    },
    {
      title: "Post Tasks, Get Results",
      subTitle: "Outsource your work to skilled professionals",
      description: "Get your tasks completed quickly and efficiently by our verified worker community.",
    ...
    },
    {
      ...
      description: "Secure payments, verified users, and 24/7 support make us the top choice for micro-work.",
