...
const GetStart = () => {
  return (
    <section className="py-20 bg-gradient-main text-center text-white">
      ...
      <div className="mt-5">
        <Link to="/register">
          <button className="btn bg-white border-bg-gradient-main text-accent font-semibold px-6 py-6 rounded-lg shadow-md hover:scale-105 transition duration-300">
