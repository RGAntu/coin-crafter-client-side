      ...
      <div className="max-w-7xl mx-auto px-6 lg:flex items-center justify-between">
        ...
        <div className="text-white max-w-lg">
          ...
          <div className="mt-6 flex gap-4">
            <Link to="/signup">
              <button className="btn bg-green-400 border-none text-white px-6 hover:bg-green-500">
                Sign Up Now
              </button>
            </Link>
            {/* <Link to="/tasks">
        ...
        {/* Right Stats Box */}
        <div className="mt-10 lg:mt-0 bg-white/10 backdrop-blur-md rounded-xl p-8 text-center text-white shadow-lg">
